...
def fit_signal_model(dataif: DataInterface) -> None:
    ...
    outcome_type = all_settings["fit_signal_model"]["cov_model"]["outcome_type"]  # load outcome_type
    ...
    fig = functions.plot_signal_model(outcome_type, name, summary, df, signal_model)
...
def fit_linear_model(dataif: DataInterface) -> None:
    ...
    outcome_type = all_settings["fit_signal_model"]["cov_model"]["outcome_type"]
    fig = functions.plot_linear_model(name, summary, df, signal_model, linear_model, outcome_type)
